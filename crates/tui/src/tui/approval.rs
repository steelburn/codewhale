...
mod ask_rules;
pub mod policy;
pub use self::ask_rules::AskRuleSavePreview;
use self::ask_rules::{build_ask_rule_save_preview, build_persistent_ask_rules};
pub use self::policy::{
...
impl ApprovalRequest {
    ...
    pub fn ask_rule_save_preview(&self) -> Option<AskRuleSavePreview> {
        build_ask_rule_save_preview(&self.persistent_ask_rules)
    }
