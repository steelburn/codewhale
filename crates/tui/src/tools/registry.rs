...
impl ToolRegistryBuilder {
    ...
    /// Include structural code search/edit tools.
    #[must_use]
    pub fn with_structural_code_tool(self) -> Self {
        use super::structural::StructuralCodeTool;
        self.with_tool(Arc::new(StructuralCodeTool))
    }
